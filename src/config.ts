...
export const config = {
  ...
  adminAuth: [
    //管理者用
    {
      ...
      //default: robotnopass
      password:
        process.env.ROBOT_ADMIN_PASS ||
        "$2b$08$4r.XgxukN5Bo/BrlDW6aYObEJgSC4o5NXOkTlGO71xQAumhHJJN72",
      permissions: "*",
    },
    //クイズ参加者用
    {
      ...
      password:
        process.env.ROBOT_PLAYER_PASS ||
        "$2b$08$7ZZ1ndbn.GG5p/WBk9WsMOZPy4pLf75vvJYbHOFkHDwWXGIqjVvfm",
    ...
    //動画/画像サーバー用
    {
      ...
      password:
        process.env.ROBOT_GUEST_PASS ||
        "$2b$08$yxLRwXjWVkJStJNNAlz5pe43xG7aLcExyViyzstVPMMVBdUe4blyi",
