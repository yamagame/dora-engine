...
export function QuizOK(node, msg, options, isTemplated) {
  QuizButton("ok", node, msg, options, isTemplated)
}

export function QuizOKImage(node, msg, options, isTemplated) {
  QuizButton("ok/image", node, msg, options, isTemplated)
}

export function QuizNG(node, msg, options, isTemplated) {
  QuizButton("ng", node, msg, options, isTemplated)
}

export function QuizNGImage(node, msg, options, isTemplated) {
  QuizButton("ng/image", node, msg, options, isTemplated)
}

export function QuizCategory(node, msg, options, isTemplated) {
  if (typeof msg.quiz === "undefined") msg.quiz = utils.quizObject()
...
export async function QuizSlide(node, msg, options, isTemplated) {
  if (typeof msg.quiz === "undefined") msg.quiz = utils.quizObject()
  let message = options
  if (isTemplated) {
    message = utils.mustache.render(message, msg)
...
export function Quiz(DORA, config = {}) {
  /**
   *
   *
   */
